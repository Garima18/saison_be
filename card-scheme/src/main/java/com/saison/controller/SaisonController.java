...
public class SaisonController {
	...
	public void showStats(HttpServletRequest request, HttpServletResponse response, @RequestParam Integer start, @RequestParam Integer limit) throws IOException {
